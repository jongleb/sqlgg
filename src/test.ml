...
let test_datefns = [
  ...
  tt "SELECT FROM_UNIXTIME(1691600000) AS from_unix_dt" [attr' ~nullability:Strict "from_unix_dt" Datetime] [];
  tt "SELECT FROM_UNIXTIME(1691600000, '%Y-%m-%d') AS from_unix_str" [attr' ~nullability:Strict "from_unix_str" Text] [];
