module Sqlgg (T : Sqlgg_traits.M) = struct
  ...
  let create_orders db  =
    T.execute_unprepared db ("CREATE TABLE orders (id INT PRIMARY KEY, user_id INT, total INT)")
