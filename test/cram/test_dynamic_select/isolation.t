...
q1 fragment with q2 select is rejected:
  ...
  [2]
  $ grep -q "Q1.t" errors.log && grep -q "Q2.t" errors.log && echo "rejected: q1 fragment is not a q2 fragment"
  rejected: q1 fragment is not a q2 fragment

Nor combined through the library-level Dynamic_select.apply:

  $ ocamlfind ocamlc -package sqlgg.traits -I . -c mix_apply_bad.ml 2>errors2.log
  [2]
  $ grep -q "Q1.Cols.t" errors2.log && grep -q "Q2" errors2.log && echo "rejected: apply does not mix brands"
